...
class TopDownMpiiDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def evaluate(self, results, res_folder=None, metric='PCKh', **kwargs):
        ...
        # The problem here is that we have (17) keypoints in result but ground truth is 16.
        # pos_pred_src -> (17, 2, 2958) <- probably in COCO format
        # pos_gt_src -> (16, 2, 2958)
        # TODO: gather only handpicked keypoints
